  ...
  columns: [
    {
      ...
      prop: 'label',
      default: $t('ngform.item.checkbox.name'),//'多选框',
      span: 24
    },
    {
  ...
  group: [
    {
      ...
      column: [
        ...
        {
          label: $t('ngform.item.datasource_static'),
          prop: 'options',
          default: [
            {
              value: '1',
        ...
        {
          label: $t('ngform.item.post_data'),
          prop: 'dynamicPostData',
          show: false
        },
        {
          label: $t('ngform.item.api_path'),
          prop: 'remoteFunc',
          show: false
        },
        {
          label: $t('ngform.item.data_path'),
          prop: 'dataPath',
          show: false
        },
        {
          label: $t('ngform.item.filed_value'),
          prop: 'remoteValue',
          show: false
        },
        {
          label: $t('ngform.item.filed_label'),
          prop: 'remoteLabel',
          show: false
        },
        {
