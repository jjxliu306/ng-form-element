        ...
        >
            <ul>
                ...
                <li @click="handleDownMerge">
                   ...
                   {{t('ngform.item.table.merge_down')}}
                </li>
                <li @click="handleRightMerge">
                    <i class="el-icon-right" />
                   {{t('ngform.item.table.merge_right')}}
                </li>
                <li @click="handleAddCol">
                    <i class="el-icon-zoom-in" />
                    {{t('ngform.item.table.add_col')}}
                </li>
                <li @click="handleAddRow">
                    <i class="el-icon-zoom-in" />
                   {{t('ngform.item.table.add_row')}}
                </li>
                <hr />
                <li @click="handleRemoveRow">
                    <i class="el-icon-zoom-out" />
                    {{t('ngform.item.table.delete_col')}}
                </li>
                <li @click="handleRemoveCol">
                    <i class="el-icon-zoom-out" />
                   {{t('ngform.item.table.delete_row')}}
                </li>
            </ul>
        </div>
            ...
            >
                <el-form-item label="class">
                    <el-input
                       ...
                       :placeholder="t('ngform.item.table.class_placeholder')"
                    />
                </el-form-item>
