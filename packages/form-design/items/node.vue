...
export default {
  ...
  watch: {
    ...
    listenModelValue: {
      handler(val, oldVal) {
        ...
        dynamicVoidFun(this.record.options.listenModelScript, this.models, undefined, undefined, undefined, this)
  ...
  methods: {
    ...
    handleFocus(e) {
      ...
      dynamicVoidFun(focusEventScript, this.models, undefined, undefined, undefined, this)
    },
    handleBlur(e) {
      if (!this.record || !this.record.options) return
      // 判断是否有监听
